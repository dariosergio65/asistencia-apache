...
<nav class="navbar navbar-dark bg-dark" >
	...
	<div class="container">
		...
		<a href="/asistencia/menuadmin.php" class="navbar-brand" style="color:yellow;">MENU PRINCIPAL</a>
    <!--h5 style="color:green;">Usuario: <?php //if (isset($nombre)){ echo ' ' . $nombre;}?> </h5-->
    <!--h5 style="color:green;">Fecha: <?php //echo date('l jS \of F Y'); ?> </h5-->
    <h5 style="color:YELLOW;">ASISTENCIA SERVICIOS LAGO </h5>
